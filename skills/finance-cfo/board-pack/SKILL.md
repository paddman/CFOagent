---
name: board-pack
description: Create decision-ready board finance materials with performance, liquidity, outlook, risks, and asks.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "board", "pack"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Board Finance Pack

Create decision-ready board finance materials with performance, liquidity, outlook, risks, and asks.
...
decision pack related to **Board Finance Pack**.
