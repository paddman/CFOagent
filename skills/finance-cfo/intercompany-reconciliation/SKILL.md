...
description: Match intercompany balances and transactions and resolve timing, FX, and coding differences.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "intercompany", "reconciliation"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Intercompany Reconciliation

Match intercompany balances and transactions and resolve timing, FX, and coding differences.
...
decision pack related to **Intercompany Reconciliation**.
