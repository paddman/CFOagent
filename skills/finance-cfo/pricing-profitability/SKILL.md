...
description: Evaluate pricing, discounting, mix, customer profitability, and margin leakage.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "pricing", "profitability", "and"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Pricing and Profitability

Evaluate pricing, discounting, mix, customer profitability, and margin leakage.
...
decision pack related to **Pricing and Profitability**.
