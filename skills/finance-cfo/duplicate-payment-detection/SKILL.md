...
description: Detect likely duplicate invoices and payments with explainable matching rules.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "duplicate", "payment", "detection"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Duplicate Payment Detection

Detect likely duplicate invoices and payments with explainable matching rules.
...
decision pack related to **Duplicate Payment Detection**.
