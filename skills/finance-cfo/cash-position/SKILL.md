---
name: cash-position
description: Produce an entity and bank-level cash position with availability, restrictions, and concentration.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "position", "daily"]
    related_skills: ["thirteen-week-cash-flow", "liquidity-risk", "working-capital", "bank-reconciliation"]
---

# Daily Cash Position

Produce an entity and bank-level cash position with availability, restrictions, and concentration.
...
decision pack related to **Daily Cash Position**.
