...
description: Design a traceable KPI tree linking operational drivers to P&L, cash flow, and enterprise value.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "kpi", "tree", "design"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# KPI Tree Design

Design a traceable KPI tree linking operational drivers to P&L, cash flow, and enterprise value.
...
decision pack related to **KPI Tree Design**.
