...
description: Assess fraud schemes, incentives, opportunities, controls, indicators, and response plans.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "fraud", "assessment"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Fraud Risk Assessment

Assess fraud schemes, incentives, opportunities, controls, indicators, and response plans.
...
decision pack related to **Fraud Risk Assessment**.
