...
description: Support fair-value allocation to identifiable assets and liabilities and derive goodwill.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "purchase", "price", "allocation"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# Purchase Price Allocation

Support fair-value allocation to identifiable assets and liabilities and derive goodwill.
...
decision pack related to **Purchase Price Allocation**.
