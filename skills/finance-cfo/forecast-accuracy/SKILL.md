...
description: Measure forecast bias, error, volatility, and corrective actions by horizon and owner.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "forecast", "accuracy"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Forecast Accuracy

Measure forecast bias, error, volatility, and corrective actions by horizon and owner.
...
decision pack related to **Forecast Accuracy**.
