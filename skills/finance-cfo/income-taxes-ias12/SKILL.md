---
name: income-taxes-ias12
description: Prepare current and deferred tax accounting with temporary differences and recoverability evidence.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "income", "taxes", "ias12", "ias", "12"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IAS 12 Income Taxes

Prepare current and deferred tax accounting with temporary differences and recoverability evidence.
...
decision pack related to **IAS 12 Income Taxes**.
