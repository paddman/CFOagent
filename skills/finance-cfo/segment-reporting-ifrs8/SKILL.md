---
name: segment-reporting-ifrs8
description: Identify operating segments from management reporting and prepare consistent disclosures.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "segment", "reporting", "ifrs8", "8"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IFRS 8 Segment Reporting

Identify operating segments from management reporting and prepare consistent disclosures.
...
decision pack related to **IFRS 8 Segment Reporting**.
