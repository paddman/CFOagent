...
description: Build bear, base, and bull scenarios and quantify financial resilience under explicit shocks.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "scenario", "stress", "testing", "and"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Scenario and Stress Testing

Build bear, base, and bull scenarios and quantify financial resilience under explicit shocks.
...
decision pack related to **Scenario and Stress Testing**.
