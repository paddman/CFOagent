...
description: Maintain a driver-based rolling forecast with monthly actuals, reforecast logic, and decision triggers.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "rolling", "forecast"]
    related_skills: ["annual-operating-plan", "budget-variance-analysis", "management-reporting-pack", "board-pack"]
---

# Rolling Forecast

Maintain a driver-based rolling forecast with monthly actuals, reforecast logic, and decision triggers.
...
decision pack related to **Rolling Forecast**.
