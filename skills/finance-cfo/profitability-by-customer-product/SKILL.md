---
name: profitability-by-customer-product
description: Allocate direct and support costs to reveal profitability by customer, product, channel, or contract.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "profitability", "by", "customer", "product", "and"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Customer and Product Profitability

Allocate direct and support costs to reveal profitability by customer, product, channel, or contract.
...
decision pack related to **Customer and Product Profitability**.
