...
description: Run scheduled control analytics with evidence, case management, aging, and remediation.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "continuous", "monitoring"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Continuous Controls Monitoring

Run scheduled control analytics with evidence, case management, aging, and remediation.
...
decision pack related to **Continuous Controls Monitoring**.
