---
name: going-concern
description: Assess liquidity, forecasts, covenants, mitigating actions, uncertainty, and disclosure needs.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "going", "concern", "assessment"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Going Concern Assessment

Assess liquidity, forecasts, covenants, mitigating actions, uncertainty, and disclosure needs.
...
decision pack related to **Going Concern Assessment**.
