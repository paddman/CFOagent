---
name: business-combinations-ifrs3
description: Apply acquisition accounting, purchase price allocation, goodwill, and measurement-period controls.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "business", "combinations", "ifrs3", "3"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IFRS 3 Business Combinations

Apply acquisition accounting, purchase price allocation, goodwill, and measurement-period controls.

## When to use

Use this skill for governed Accounting and Reporting work when the user requests
analysis, a workpaper, a forecast, a model review, a reconciliation, or a
decision pack related to **IFRS 3 Business Combinations**.
...
1. Establish facts, transaction flow, entities, dates, currency, and source evidence.
2. Identify applicable accounting guidance and company policy before calculation.
3. Prepare calculations, entries, reconciliations, and disclosure impacts.
4. Document alternatives, judgments, estimates, uncertainty, and conclusion.
5. Obtain preparer and reviewer sign-off before posting or external reporting.
