---
name: access-review-finance
description: Perform periodic access certification for ERP, banking, payroll, tax, and reporting systems.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "access", "review"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "fraud-risk-assessment"]
---

# Finance Access Review

Perform periodic access certification for ERP, banking, payroll, tax, and reporting systems.
...
decision pack related to **Finance Access Review**.
