...
description: Measure fixed-floating exposure, duration, repricing gaps, and rate-shock sensitivity.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "interest", "rate", "risk"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Interest Rate Risk

Measure fixed-floating exposure, duration, repricing gaps, and rate-shock sensitivity.
...
decision pack related to **Interest Rate Risk**.
