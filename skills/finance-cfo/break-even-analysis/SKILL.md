...
description: Calculate contribution margin, break-even volume, margin of safety, and sensitivity.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "break", "even", "analysis"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Break-Even Analysis

Calculate contribution margin, break-even volume, margin of safety, and sensitivity.
...
decision pack related to **Break-Even Analysis**.
