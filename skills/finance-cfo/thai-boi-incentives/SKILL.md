---
name: thai-boi-incentives
description: Track promoted activities, conditions, privileges, segregated results, and compliance evidence.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "tax-thailand", "thailand", "tax", "compliance", "thai", "boi", "incentives"]
    related_skills: ["thai-corporate-income-tax", "thai-vat", "thai-withholding-tax", "thai-transfer-pricing"]
---

# Thailand BOI Incentives

Track promoted activities, conditions, privileges, segregated results, and compliance evidence.
...
decision pack related to **Thailand BOI Incentives**.
