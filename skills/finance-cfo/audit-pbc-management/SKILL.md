---
name: audit-pbc-management
description: Manage audit requests, owners, evidence quality, due dates, and secure delivery.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "pbc", "management"]
...
Manage audit requests, owners, evidence quality, due dates, and secure delivery.
...
decision pack related to **Audit PBC Management**.
