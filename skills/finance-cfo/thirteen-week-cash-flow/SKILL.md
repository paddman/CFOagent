...
description: Build a rolling direct-method cash forecast with weekly liquidity and breach alerts.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "thirteen", "week", "flow", "13", "forecast"]
    related_skills: ["cash-position", "liquidity-risk", "working-capital", "bank-reconciliation"]
---

# 13-Week Cash Flow Forecast

Build a rolling direct-method cash forecast with weekly liquidity and breach alerts.
...
decision pack related to **13-Week Cash Flow Forecast**.
