---
name: lease-accounting-ifrs16
description: Build lease schedules and account for right-of-use assets, liabilities, modifications, and disclosures.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "lease", "ifrs16", "16"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IFRS 16 Lease Accounting

Build lease schedules and account for right-of-use assets, liabilities, modifications, and disclosures.
...
decision pack related to **IFRS 16 Lease Accounting**.
