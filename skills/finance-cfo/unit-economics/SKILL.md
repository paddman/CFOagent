---
name: unit-economics
description: Measure contribution margin, CAC, LTV, payback, retention, and scalable growth economics.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "unit", "economics"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Unit Economics

Measure contribution margin, CAC, LTV, payback, retention, and scalable growth economics.
...
decision pack related to **Unit Economics**.
