...
description: Perform analytical and structural review of a trial balance before reporting.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "trial", "balance", "review"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "financial-statement-preparation"]
---

# Trial Balance Review

Perform analytical and structural review of a trial balance before reporting.
...
decision pack related to **Trial Balance Review**.
