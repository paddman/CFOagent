...
description: Control capitalization, useful lives, depreciation, transfers, disposals, and physical verification.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "fixed", "assets"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Fixed Assets Accounting

Control capitalization, useful lives, depreciation, transfers, disposals, and physical verification.
...
decision pack related to **Fixed Assets Accounting**.
