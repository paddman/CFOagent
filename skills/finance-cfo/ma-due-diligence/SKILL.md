...
description: Assess quality of earnings, working capital, debt-like items, tax, controls, and forecast credibility.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "ma", "due", "diligence", "m", "a", "financial"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# M&A Financial Due Diligence

Assess quality of earnings, working capital, debt-like items, tax, controls, and forecast credibility.
...
decision pack related to **M&A Financial Due Diligence**.
