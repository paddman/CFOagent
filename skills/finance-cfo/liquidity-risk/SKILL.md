---
name: liquidity-risk
description: Set liquidity buffers, stress scenarios, contingency actions, and escalation thresholds.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "risk", "management"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "working-capital", "bank-reconciliation"]
---

# Liquidity Risk Management

Set liquidity buffers, stress scenarios, contingency actions, and escalation thresholds.
...
decision pack related to **Liquidity Risk Management**.
