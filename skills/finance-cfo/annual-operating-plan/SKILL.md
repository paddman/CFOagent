...
description: Build an integrated annual operating plan with drivers, owners, scenarios, and approval gates.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "annual", "operating", "plan"]
    related_skills: ["rolling-forecast", "budget-variance-analysis", "management-reporting-pack", "board-pack"]
---

# Annual Operating Plan

Build an integrated annual operating plan with drivers, owners, scenarios, and approval gates.
...
decision pack related to **Annual Operating Plan**.
