---
name: fx-exposure
description: Identify transaction, translation, and economic FX exposures with natural offsets.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "fx", "exposure", "foreign", "exchange"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Foreign Exchange Exposure

Identify transaction, translation, and economic FX exposures with natural offsets.
...
decision pack related to **Foreign Exchange Exposure**.
