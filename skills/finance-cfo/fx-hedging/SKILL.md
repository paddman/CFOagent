---
name: fx-hedging
description: Design governed FX hedge strategies, instruments, effectiveness measures, and controls.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "fx", "hedging"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# FX Hedging

Design governed FX hedge strategies, instruments, effectiveness measures, and controls.
...
decision pack related to **FX Hedging**.
