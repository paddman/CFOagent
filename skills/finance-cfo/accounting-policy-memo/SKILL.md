---
name: accounting-policy-memo
description: Write evidence-based accounting memos separating facts, guidance, analysis, judgment, and conclusion.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "policy", "memo"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Accounting Policy Memo

Write evidence-based accounting memos separating facts, guidance, analysis, judgment, and conclusion.
...
decision pack related to **Accounting Policy Memo**.
