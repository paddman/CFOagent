---
name: thai-e-tax-invoice
description: Assess e-tax document process, master data, signatures, transmission, archive, and reconciliation.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "tax-thailand", "thailand", "tax", "compliance", "thai", "e", "invoice", "and", "receipt"]
    related_skills: ["thai-corporate-income-tax", "thai-vat", "thai-withholding-tax", "thai-transfer-pricing"]
---

# Thailand e-Tax Invoice and e-Receipt

Assess e-tax document process, master data, signatures, transmission, archive, and reconciliation.

## When to use

Use this skill for governed Thailand Tax and Regulation work when the user requests
analysis, a workpaper, a forecast, a model review, a reconciliation, or a
decision pack related to **Thailand e-Tax Invoice and e-Receipt**.
...
1. Determine transaction facts, parties, dates, source jurisdiction, and documentation.
2. Verify the current official Thai rule and effective date from an authoritative source.
3. Calculate tax treatment and reconcile tax records to ledger and payments.
4. List exceptions, missing evidence, uncertain positions, penalties, and corrective action.
5. Prepare a review package; an authorized human submits and pays.
