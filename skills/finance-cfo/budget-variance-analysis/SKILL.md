...
description: Analyze actual versus budget, isolate rate-volume-mix drivers, and produce accountable actions.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "budget", "variance", "analysis"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "management-reporting-pack", "board-pack"]
---

# Budget Variance Analysis

Analyze actual versus budget, isolate rate-volume-mix drivers, and produce accountable actions.
...
decision pack related to **Budget Variance Analysis**.
