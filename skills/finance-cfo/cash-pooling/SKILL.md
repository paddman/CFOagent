---
name: cash-pooling
description: Design cash concentration and intercompany funding with legal, tax, liquidity, and accounting controls.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "pooling", "and", "intercompany", "funding"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Cash Pooling and Intercompany Funding

Design cash concentration and intercompany funding with legal, tax, liquidity, and accounting controls.
...
decision pack related to **Cash Pooling and Intercompany Funding**.
