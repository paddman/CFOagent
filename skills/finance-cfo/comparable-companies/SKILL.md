...
description: Select peers, normalize metrics, calculate trading multiples, and interpret valuation ranges.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "comparable", "companies", "company", "analysis"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# Comparable Company Analysis

Select peers, normalize metrics, calculate trading multiples, and interpret valuation ranges.
...
decision pack related to **Comparable Company Analysis**.
