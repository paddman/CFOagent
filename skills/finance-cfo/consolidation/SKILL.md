---
name: consolidation
description: Consolidate entities with mapping, ownership, foreign currency, eliminations, and control checks.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "consolidation", "group"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Group Consolidation

Consolidate entities with mapping, ownership, foreign currency, eliminations, and control checks.
...
decision pack related to **Group Consolidation**.
