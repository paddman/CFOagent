---
name: vendor-master-controls
description: Control vendor onboarding, changes, bank validation, duplicates, conflicts, and periodic review.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "vendor", "master"]
...
Control vendor onboarding, changes, bank validation, duplicates, conflicts, and periodic review.
...
decision pack related to **Vendor Master Controls**.
