...
description: Improve DSO, DIO, DPO, cash conversion cycle, and cross-functional cash accountability.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "working", "capital", "management"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "bank-reconciliation"]
---

# Working Capital Management

Improve DSO, DIO, DPO, cash conversion cycle, and cross-functional cash accountability.
...
decision pack related to **Working Capital Management**.
