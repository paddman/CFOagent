...
description: Prepare internally consistent primary statements with tie-outs, classifications, and disclosures.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "financial", "statement", "preparation"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Financial Statement Preparation

Prepare internally consistent primary statements with tie-outs, classifications, and disclosures.
...
decision pack related to **Financial Statement Preparation**.
