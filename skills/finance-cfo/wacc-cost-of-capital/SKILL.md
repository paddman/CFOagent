...
description: Estimate cost of equity, debt, capital structure, and sensitivity with sourced market inputs.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "wacc", "cost", "of", "capital", "and"]
    related_skills: ["capital-allocation", "business-case", "dcf-review", "comparable-companies"]
---

# WACC and Cost of Capital

Estimate cost of equity, debt, capital structure, and sensitivity with sourced market inputs.
...
decision pack related to **WACC and Cost of Capital**.
