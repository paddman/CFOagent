...
description: Map process risks to control objectives, activities, owners, frequency, evidence, and testing.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "control", "matrix", "and"]
    related_skills: ["internal-control-framework", "segregation-of-duties", "access-review-finance", "fraud-risk-assessment"]
---

# Risk and Control Matrix

Map process risks to control objectives, activities, owners, frequency, evidence, and testing.
...
decision pack related to **Risk and Control Matrix**.
