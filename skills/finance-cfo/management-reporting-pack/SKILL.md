...
description: Produce a concise monthly management pack with KPI trends, material variances, risks, and actions.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "management", "reporting", "pack"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "board-pack"]
---

# Management Reporting Pack

Produce a concise monthly management pack with KPI trends, material variances, risks, and actions.
...
decision pack related to **Management Reporting Pack**.
