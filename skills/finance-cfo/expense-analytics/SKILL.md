...
description: Detect policy exceptions, duplicate claims, split transactions, outliers, and suspicious patterns.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "expense", "analytics", "and", "t", "e"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Expense and T&E Analytics

Detect policy exceptions, duplicate claims, split transactions, outliers, and suspicious patterns.
...
decision pack related to **Expense and T&E Analytics**.
