---
name: erp-ledger-ingestion
description: Ingest finance data with schema mapping, control totals, lineage, and incremental load controls.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "industry-data", "data", "analytics", "metrics", "erp", "ledger", "ingestion", "and"]
    related_skills: ["saas-metrics", "telecom-metrics", "idc-cloud-unit-economics", "project-profitability"]
---

# ERP and Ledger Ingestion

Ingest finance data with schema mapping, control totals, lineage, and incremental load controls.
...
decision pack related to **ERP and Ledger Ingestion**.
