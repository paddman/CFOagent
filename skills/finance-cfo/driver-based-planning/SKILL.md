...
description: Translate operational drivers into revenue, cost, headcount, cash, and capacity forecasts.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "driver", "based"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Driver-Based Planning

Translate operational drivers into revenue, cost, headcount, cash, and capacity forecasts.
...
decision pack related to **Driver-Based Planning**.
