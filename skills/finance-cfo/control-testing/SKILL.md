...
description: Test control design, population completeness, sample execution, evidence, and exceptions.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "control", "testing", "design", "and", "operating", "effectiveness"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Control Design and Operating Effectiveness Testing

Test control design, population completeness, sample execution, evidence, and exceptions.

## When to use

Use this skill for governed Risk, Audit, and Controls work when the user requests
analysis, a workpaper, a forecast, a model review, a reconciliation, or a
decision pack related to **Control Design and Operating Effectiveness Testing**.
...
1. Define process objective, scope, systems, handoffs, and failure modes.
2. Map inherent risks to preventive, detective, and compensating controls.
3. Test design and operating evidence using a complete population and documented sample.
4. Classify exceptions by impact, root cause, ownership, and remediation date.
5. Retest remediation and preserve an immutable evidence trail.
