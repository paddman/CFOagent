...
description: Run a controlled period-end close with dependencies, evidence, reviews, and final lock.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "month", "end"]
    related_skills: ["account-reconciliation", "journal-entry-review", "trial-balance-review", "financial-statement-preparation"]
---

# Month-End Close

Run a controlled period-end close with dependencies, evidence, reviews, and final lock.
...
decision pack related to **Month-End Close**.
