---
name: post-merger-integration-finance
description: Plan Day 1 controls, close, treasury, reporting, systems, synergy tracking, and governance.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "post", "merger", "integration"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# Post-Merger Finance Integration

Plan Day 1 controls, close, treasury, reporting, systems, synergy tracking, and governance.
...
decision pack related to **Post-Merger Finance Integration**.
