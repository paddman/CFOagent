---
name: audit-planning
description: Prioritize audit coverage using impact, likelihood, change, control maturity, and prior findings.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "planning", "based"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Risk-Based Audit Planning

Prioritize audit coverage using impact, likelihood, change, control maturity, and prior findings.
...
decision pack related to **Risk-Based Audit Planning**.
