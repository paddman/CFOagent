...
description: Detect explainable transaction and KPI anomalies with baselines, thresholds, and case workflow.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "industry-data", "data", "analytics", "metrics", "anomaly", "detection"]
    related_skills: ["saas-metrics", "telecom-metrics", "idc-cloud-unit-economics", "project-profitability"]
---

# Finance Anomaly Detection

Detect explainable transaction and KPI anomalies with baselines, thresholds, and case workflow.
...
decision pack related to **Finance Anomaly Detection**.
