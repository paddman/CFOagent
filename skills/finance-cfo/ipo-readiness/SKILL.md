---
name: ipo-readiness
description: Assess reporting, controls, governance, forecast, data, audit, and public-company readiness.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "ipo", "readiness"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# IPO Readiness

Assess reporting, controls, governance, forecast, data, audit, and public-company readiness.
...
decision pack related to **IPO Readiness**.
