---
name: saas-metrics
description: Calculate ARR, MRR, churn, retention, expansion, CAC, LTV, payback, and Rule of 40.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "industry-data", "data", "analytics", "metrics", "saas"]
    related_skills: ["telecom-metrics", "idc-cloud-unit-economics", "project-profitability", "data-quality-finance"]
---

# SaaS Metrics

Calculate ARR, MRR, churn, retention, expansion, CAC, LTV, payback, and Rule of 40.
...
decision pack related to **SaaS Metrics**.
