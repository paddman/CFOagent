...
description: Run a governed disclosure checklist with applicability, evidence, preparer, and reviewer sign-off.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "disclosure", "checklist", "financial", "statement"]
...
Run a governed disclosure checklist with applicability, evidence, preparer, and reviewer sign-off.
...
decision pack related to **Financial Statement Disclosure Checklist**.
