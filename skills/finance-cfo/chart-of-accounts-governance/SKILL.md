...
description: Govern account creation, hierarchy, mappings, ownership, usage rules, and change control.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "chart", "of", "accounts", "governance"]
...
Govern account creation, hierarchy, mappings, ownership, usage rules, and change control.
...
decision pack related to **Chart of Accounts Governance**.
