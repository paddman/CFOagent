...
description: Normalize EBITDA and cash conversion by separating recurring performance from one-offs and policy effects.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "quality", "of", "earnings"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# Quality of Earnings

Normalize EBITDA and cash conversion by separating recurring performance from one-offs and policy effects.
...
decision pack related to **Quality of Earnings**.
