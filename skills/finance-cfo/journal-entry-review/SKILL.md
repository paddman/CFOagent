...
description: Validate journal support, accounting logic, balance, period, entity, and approval.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "journal", "entry", "review"]
    related_skills: ["month-end-close", "account-reconciliation", "trial-balance-review", "financial-statement-preparation"]
---

# Journal Entry Review

Validate journal support, accounting logic, balance, period, entity, and approval.
...
decision pack related to **Journal Entry Review**.
