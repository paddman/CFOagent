...
description: Build and reconcile operating, investing, and financing cash flows with non-cash disclosures.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "cash", "flow", "statement"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Cash Flow Statement

Build and reconcile operating, investing, and financing cash flows with non-cash disclosures.
...
decision pack related to **Cash Flow Statement**.
