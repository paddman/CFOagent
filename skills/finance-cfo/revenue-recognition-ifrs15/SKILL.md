---
name: revenue-recognition-ifrs15
description: Apply the five-step revenue model and document performance obligations, timing, and judgments.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "revenue", "recognition", "ifrs15", "15"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IFRS 15 Revenue Recognition

Apply the five-step revenue model and document performance obligations, timing, and judgments.
...
decision pack related to **IFRS 15 Revenue Recognition**.
