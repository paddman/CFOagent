---
name: debt-capacity
description: Assess sustainable leverage, debt service, downside headroom, and refinancing risk.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "debt", "capacity"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Debt Capacity

Assess sustainable leverage, debt service, downside headroom, and refinancing risk.
...
decision pack related to **Debt Capacity**.
