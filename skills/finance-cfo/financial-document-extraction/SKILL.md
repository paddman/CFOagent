...
description: Extract structured fields from invoices, statements, contracts, and reports with confidence and review.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "industry-data", "data", "analytics", "metrics", "financial", "document", "extraction"]
    related_skills: ["saas-metrics", "telecom-metrics", "idc-cloud-unit-economics", "project-profitability"]
---

# Financial Document Extraction

Extract structured fields from invoices, statements, contracts, and reports with confidence and review.
...
decision pack related to **Financial Document Extraction**.
