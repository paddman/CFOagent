---
name: business-case
description: Build an auditable business case with cash flows, NPV, IRR, payback, scenarios, and benefits ownership.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "business", "case"]
    related_skills: ["capital-allocation", "wacc-cost-of-capital", "dcf-review", "comparable-companies"]
---

# Investment Business Case

Build an auditable business case with cash flows, NPV, IRR, payback, scenarios, and benefits ownership.
...
decision pack related to **Investment Business Case**.
