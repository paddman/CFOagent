...
description: Create a treasury policy covering liquidity, investments, funding, FX, counterparties, and approvals.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "policy"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Treasury Policy

Create a treasury policy covering liquidity, investments, funding, FX, counterparties, and approvals.
...
decision pack related to **Treasury Policy**.
