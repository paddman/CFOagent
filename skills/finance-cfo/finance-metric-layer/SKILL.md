---
name: finance-metric-layer
description: Define governed finance metrics with formulas, grain, dimensions, owners, and tests.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "industry-data", "data", "analytics", "metrics", "metric", "layer"]
    related_skills: ["saas-metrics", "telecom-metrics", "idc-cloud-unit-economics", "project-profitability"]
---

# Finance Metric Layer

Define governed finance metrics with formulas, grain, dimensions, owners, and tests.
...
decision pack related to **Finance Metric Layer**.
