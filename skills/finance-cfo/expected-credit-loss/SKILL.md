...
description: Develop governed ECL staging, PD, LGD, EAD, forward-looking overlays, and disclosures.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "expected", "credit", "loss"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# Expected Credit Loss

Develop governed ECL staging, PD, LGD, EAD, forward-looking overlays, and disclosures.
...
decision pack related to **Expected Credit Loss**.
