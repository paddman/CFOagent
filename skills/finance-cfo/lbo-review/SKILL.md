---
name: lbo-review
description: Review sources and uses, debt paydown, cash sweeps, covenants, returns, and downside cases.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "lbo", "review", "model"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# LBO Model Review

Review sources and uses, debt paydown, cash sweeps, covenants, returns, and downside cases.
...
decision pack related to **LBO Model Review**.
