---
name: merger-model-review
description: Review transaction mechanics, financing, synergies, purchase accounting, and accretion or dilution.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "merger", "model", "review"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# Merger Model Review

Review transaction mechanics, financing, synergies, purchase accounting, and accretion or dilution.
...
decision pack related to **Merger Model Review**.
