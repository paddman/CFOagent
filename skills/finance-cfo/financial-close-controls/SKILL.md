...
description: Design and monitor controls over close, consolidation, review, disclosures, and period lock.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "financial", "close"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Financial Close Controls

Design and monitor controls over close, consolidation, review, disclosures, and period lock.
...
decision pack related to **Financial Close Controls**.
