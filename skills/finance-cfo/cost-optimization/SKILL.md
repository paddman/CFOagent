...
description: Identify sustainable cost actions using spend, activity, service level, and risk trade-offs.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "fpna", "planning", "forecasting", "performance", "cost", "optimization"]
    related_skills: ["annual-operating-plan", "rolling-forecast", "budget-variance-analysis", "management-reporting-pack"]
---

# Cost Optimization

Identify sustainable cost actions using spend, activity, service level, and risk trade-offs.
...
decision pack related to **Cost Optimization**.
