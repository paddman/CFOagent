...
description: Reconcile general ledger balances to independent evidence and resolve aged differences.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "account", "reconciliation"]
    related_skills: ["month-end-close", "journal-entry-review", "trial-balance-review", "financial-statement-preparation"]
---

# Account Reconciliation

Reconcile general ledger balances to independent evidence and resolve aged differences.
...
decision pack related to **Account Reconciliation**.
