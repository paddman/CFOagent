---
name: ma-screening
description: Score acquisition targets against strategy, economics, capabilities, risk, and integration feasibility.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "ma", "screening", "m", "a", "target"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "dcf-review"]
---

# M&A Target Screening

Score acquisition targets against strategy, economics, capabilities, risk, and integration feasibility.
...
decision pack related to **M&A Target Screening**.
