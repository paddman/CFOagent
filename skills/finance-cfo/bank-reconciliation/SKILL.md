...
description: Reconcile bank statements to the ledger and investigate timing, fees, errors, and fraud indicators.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "bank", "reconciliation"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Bank Reconciliation

Reconcile bank statements to the ledger and investigate timing, fees, errors, and fraud indicators.
...
decision pack related to **Bank Reconciliation**.
