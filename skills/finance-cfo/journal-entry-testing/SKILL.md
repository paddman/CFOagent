...
description: Risk-rank journals and test unusual users, times, accounts, amounts, and descriptions.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "risk-controls", "controls", "audit", "risk", "journal", "entry", "testing"]
    related_skills: ["internal-control-framework", "risk-control-matrix", "segregation-of-duties", "access-review-finance"]
---

# Journal Entry Testing

Risk-rank journals and test unusual users, times, accounts, amounts, and descriptions.
...
decision pack related to **Journal Entry Testing**.
