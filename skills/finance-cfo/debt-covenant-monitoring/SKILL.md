...
description: Maintain debt schedules, covenant calculations, headroom forecasts, and early-warning escalation.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "debt", "covenant", "monitoring", "and"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Debt and Covenant Monitoring

Maintain debt schedules, covenant calculations, headroom forecasts, and early-warning escalation.
...
decision pack related to **Debt and Covenant Monitoring**.
