---
name: foreign-currency-ias21
description: Determine functional currency and account for transactions, translation, and exchange differences.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "foreign", "currency", "ias21", "ias", "21"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IAS 21 Foreign Currency

Determine functional currency and account for transactions, translation, and exchange differences.
...
decision pack related to **IAS 21 Foreign Currency**.
