---
name: thai-vat
description: Reconcile output and input VAT, assess documentation, exceptions, and filing readiness.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "tax-thailand", "thailand", "tax", "compliance", "thai", "vat"]
    related_skills: ["thai-corporate-income-tax", "thai-withholding-tax", "thai-transfer-pricing", "thai-tax-provision"]
---

# Thailand VAT

Reconcile output and input VAT, assess documentation, exceptions, and filing readiness.
...
decision pack related to **Thailand VAT**.
