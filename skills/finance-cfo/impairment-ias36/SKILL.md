...
description: Test assets and cash-generating units for impairment using supportable cash flows and discount rates.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "accounting", "close", "ifrs", "impairment", "ias36", "ias", "36", "testing"]
    related_skills: ["month-end-close", "account-reconciliation", "journal-entry-review", "trial-balance-review"]
---

# IAS 36 Impairment Testing

Test assets and cash-generating units for impairment using supportable cash flows and discount rates.
...
decision pack related to **IAS 36 Impairment Testing**.
