---
name: bank-account-governance
description: Govern bank accounts, signatories, access, mandates, confirmations, and dormant-account closure.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "treasury", "cash", "liquidity", "bank", "account", "governance"]
    related_skills: ["cash-position", "thirteen-week-cash-flow", "liquidity-risk", "working-capital"]
---

# Bank Account Governance

Govern bank accounts, signatories, access, mandates, confirmations, and dormant-account closure.
...
decision pack related to **Bank Account Governance**.
