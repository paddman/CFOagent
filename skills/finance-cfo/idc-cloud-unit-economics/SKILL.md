---
name: idc-cloud-unit-economics
description: Measure rack, power, bandwidth, VM, storage, occupancy, utilization, and contribution margin economics.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "industry-data", "data", "analytics", "metrics", "idc", "cloud", "unit", "economics", "and"]
    related_skills: ["saas-metrics", "telecom-metrics", "project-profitability", "data-quality-finance"]
---

# IDC and Cloud Unit Economics

Measure rack, power, bandwidth, VM, storage, occupancy, utilization, and contribution margin economics.
...
decision pack related to **IDC and Cloud Unit Economics**.
