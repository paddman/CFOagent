---
name: dcf-review
description: Review DCF architecture, forecast logic, terminal value, discounting, bridge, and sensitivities.
version: 1.0.0
author: CFOAgent
license: MIT
...
metadata:
  hermes:
    tags: ["finance", "corporate-finance", "valuation", "investment", "m&a", "dcf", "review", "model"]
    related_skills: ["capital-allocation", "business-case", "wacc-cost-of-capital", "comparable-companies"]
---

# DCF Model Review

Review DCF architecture, forecast logic, terminal value, discounting, bridge, and sensitivities.
...
decision pack related to **DCF Model Review**.
